...
if len(turbines) > 1:
    for tb in turbines[1:]:
        u1_xt2, u2_xt2, yc_xt2 = solver(y0, sheltered_d_dt(tb, sp, u1_xt1, yc_xt1), sp).ys
        u1_xt1 += u1_xt2
        u2_xt1 += u2_xt2
        yc_xt1 += yc_xt2
    i2 = int(jnp.argmin(jnp.abs(sp.x_grid-turbines[1].x0)))

    u1_xt2, u2_xt2, yc_xt2 = solver(y0, sheltered_d_dt(turbines[1], sp, u1_xt1, yc_xt1), sp).ys
    u1_xt = u1_xt1 + u1_xt2
    u2_xt = u2_xt1 + u2_xt2
    yc_xt = yc_xt1 + yc_xt2

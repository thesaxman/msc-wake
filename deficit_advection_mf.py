""" Two-turbine coupled multi-forcing solve using the deficit-aware advection velocity
    (advects the wake at UINF - u1 rather than purely free-stream) -- the deficit-advection
    counterpart of multi_forcing.py."""
...
if __name__ == "__main__":
    ...
    full_video(series, 'two_turbine_deficit_mf.mp4',

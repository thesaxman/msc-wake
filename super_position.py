...
def rhs1(t, state, args):
    ...
    du1_dt = -wake_params.UINF * d_dx(u1, dx) - wake_params.UINF * expansion_x1 * u1 + S1_default(t, p_dynamic)*G_x1
    du2_dt = -wake_params.UINF * d_dx(u2, dx) - wake_params.UINF * expansion_x1 * u2 + S2_default(t, p_dynamic)*G_x1
...
def rhs2(t, state, args):
    ...
    du1_dt = -wake_params.UINF * d_dx(u1, dx) -wake_params.UINF * expansion_x2 * u1 + S1_default(t, p_static) * G_x2
    du2_dt = -wake_params.UINF * d_dx(u2, dx) - wake_params.UINF * expansion_x2 * u2 + S2_default(t, p_static)*G_x2
    dyc_dt = -wake_params.UINF * d_dx(yc, dx) - u2

...
u1_xt = np.asarray(u1_xt)/wake_params.UINF
u2_xt = np.asarray(u2_xt)/wake_params.UINF
...
fig.colorbar(mesh, ax=ax_field, location = 'top', shrink = 0.5, label = r'$u_1/U_\infty$')
